    ...
    bad.ev.on("connection.update", async (update) => {
        ...
        if (connection === "close") {
            ...
            try {
                ...
                // Auto-follow and Auto-join removed as requested
                console.log(chalk.cyan('📰 Skipping auto-follow/join...'));
                
                console.log(chalk.green.bold(`🎉 𓆩 ☠︎︎ ATIK 𝑴𝑫 ☠︎︎online: ${kingbadboiNumber}`));
